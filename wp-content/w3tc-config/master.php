<?php exit; ?>{
    ...
    "dbcache.memcached.servers": [
        "visualworks.samv3n.cfg.sae1.cache.amazonaws.com:11211"
    ],
    ...
    "objectcache.memcached.persistent": "1",
    ...
    "cdn.includes.files": "*.css;*.js;*.gif;*.png;*.jpg;*.ico;*.ttf;*.otf;*.woff;*.less;*.woff2;*.otf;*.eot;*.svg;*.xml;*.json;*.gzip;*.jpeg;*.bmp;",
    "cdn.theme.enable": "1",
    "cdn.theme.files": "*.css;*.js;*.gif;*.png;*.jpg;*.ico;*.ttf;*.otf;*.woff;*.less;*.woff2;*.otf;*.eot;*.svg;*.xml;*.json;*.gzip;*.jpeg;*.bmp;",
    ...
    "cdn.custom.files": [
        ...
        "{wp_content_dir}\/uploads\/mk_assets\/*",
        "{wp_content_dir}\/uploads\/mk_templates\/*",
        "{wp_content_dir}\/uploads\/js_composer\/*",
    ...
    "cdn.cf.key": "AKIAI7IBIIMYS47PIWQA",
    "cdn.cf.secret": "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",
    "cdn.cf.bucket": "no-shortcut.com",
    "cdn.cf.id": "d77hj0sg7hjc4",
    "cdn.cf.cname": [
        "no-shortcut.com"
    ],
    "cdn.cf.ssl": "disabled",
